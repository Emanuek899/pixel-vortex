...
class Community(models.Model):
    ...
    users = models.ManyToManyField(CustomUser, related_name="community_users", blank=True)
    users_count = models.IntegerField(default=0)
    creation_date = models.DateTimeField(auto_now_add=True)
    status = models.CharField(choices=[("A", "Active"), ("I", "Inactive")], max_length=20)
    category = models.ForeignKey(Genre, related_name="categories", on_delete=models.SET_NULL, null=True, blank=True)
